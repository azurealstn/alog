package com.azurealstn.alog.Infra.exception.hashtag;
 ...
 */
public class HashTagNotFound extends GlobalException {

    private static final String MESSAGE = "해당 해쉬태그가y 없습니다.";
